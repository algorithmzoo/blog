...
# extras
	...
	x$ago.16   <- lag(x$ret, k=15)   
	x$ago.17   <- lag(x$ret, k=16)   
	x$ago.18   <- lag(x$ret, k=17)   
	x$ago.19   <- lag(x$ret, k=18)   
	x$ago.20   <- lag(x$ret, k=19)   
	x$ago.21   <- lag(x$ret, k=20)   
	x$ago.22   <- lag(x$ret, k=21)   
	x$ago.23   <- lag(x$ret, k=22)   
	x$ago.24   <- lag(x$ret, k=23)   
	x$ago.25   <- lag(x$ret, k=24)   
	x$ago.26   <- lag(x$ret, k=25)   
	x$ago.27   <- lag(x$ret, k=26)   
	x$ago.28   <- lag(x$ret, k=27)   
	x$ago.29   <- lag(x$ret, k=28)   
	x$ago.30   <- lag(x$ret, k=29)
